(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["GlRenderer"] = factory();
  else root["GlRenderer"] = factory();
})(this, function () {
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _renderer__WEBPACK_IMPORTED_MODULE_0__ =
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2___default =
          /*#__PURE__*/ __webpack_require__.n(
            _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2__
          );
        /* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(11);
        /* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_3___default =
          /*#__PURE__*/ __webpack_require__.n(
        ...
        /* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_4___default =
          /*#__PURE__*/ __webpack_require__.n(
            _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_4__
          );
        /* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(16);
        /* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_5___default =
          /*#__PURE__*/ __webpack_require__.n(
        ...
        /* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_7__ =
          __webpack_require__(18);
        /* harmony import */ var _default_vert_glsl__WEBPACK_IMPORTED_MODULE_8__ =
          __webpack_require__(20);
        /* harmony import */ var _default_vert_glsl__WEBPACK_IMPORTED_MODULE_8___default =
          /*#__PURE__*/ __webpack_require__.n(
            _default_vert_glsl__WEBPACK_IMPORTED_MODULE_8__
          );
        /* harmony import */ var _default_frag_glsl__WEBPACK_IMPORTED_MODULE_9__ =
          __webpack_require__(21);
        /* harmony import */ var _default_frag_glsl__WEBPACK_IMPORTED_MODULE_9___default =
          /*#__PURE__*/ __webpack_require__.n(
            _default_frag_glsl__WEBPACK_IMPORTED_MODULE_9__
          );
        /* harmony import */ var _default_feeback_vert_glsl__WEBPACK_IMPORTED_MODULE_10__ =
          __webpack_require__(22);
        /* harmony import */ var _default_feeback_vert_glsl__WEBPACK_IMPORTED_MODULE_10___default =
          /*#__PURE__*/ __webpack_require__.n(
            _default_feeback_vert_glsl__WEBPACK_IMPORTED_MODULE_10__
          );
        ...
        var Renderer = /*#__PURE__*/ (function () {
            ...
            [
              ...
              },
              {
                ...
                value: function FLOAT(points, buffer) {
                  return Object(
                    _helpers__WEBPACK_IMPORTED_MODULE_7__["pointsToBuffer"]
                  )(points, Float32Array, buffer);
                },
              },
              {
                key: "UNSIGNED_BYTE",
          ...
          function Renderer(canvas) {
            ...
            if (gl == null) {
              gl = Object(_helpers__WEBPACK_IMPORTED_MODULE_7__["setupWebGL"])(
                canvas,
                this.options
              );
                      ...
                      set: function set(v) {
                        ...
                        if (isMatrix) setUniform(uniform, false, v);
                          ...
                          setUniform.apply(
                            void 0,
                            [uniform].concat(
                              _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_3___default()(
                                v
                              )
                            )
                          );
              ...
              },
              {
                ...
                value: function _draw() {
                  ...
                  program.meshData.forEach(function (meshData, meshIndex) {
                    ...
                    var gl = _this.gl;
                    var mode =
                      meshData.mode != null ? meshData.mode : gl.TRIANGLES;
                    ...
                    gl.bindBuffer(
                      gl.ARRAY_BUFFER,
                      program._buffers.verticesBuffer
                    );
                        ...
                        if (divisor != null) {
                          ...
                          if (location >= 0) {
                            ...
                            if (gl.vertexAttribDivisor) {
                              ...
                              _this.aia_ext.vertexAttribDivisorANGLE(
                                location,
                                divisor
                              );
                            }
                    ...
                    if (
                      ...
                      program._buffers.texCoordBuffer
                    ) {
                      var texVertexData =
                        textureCoord ||
                        mapTextureCoordinate(positions, program._dimension);
                      gl.bindBuffer(
                        gl.ARRAY_BUFFER,
                        program._buffers.texCoordBuffer
                      );
                    ...
                    if (instanceCount != null) {
                      if (cells) {
                        if (gl.drawElementsInstanced) {
                          ...
                          _this.aia_ext.drawElementsInstancedANGLE(
                            mode,
                            cellsCount,
                            gl.UNSIGNED_SHORT,
                            0,
                        ...
                        _this.aia_ext.drawArraysInstancedANGLE(
                          mode,
                          0,
                          count,
                          instanceCount
     ...
     */
              },
              {
                ...
                value: function setMeshData(data) {
                  ...
                  program.meshData = data.map(function (_ref4) {
                    ...
                    if (instanceCount != null) {
                      if (!_this2.isWebGL2 && !_this2.aia_ext)
                        throw new Error(
              ...
              },
              {
                ...
                value: function createProgram(fragmentShader, vertexShader) {
                  ...
                  // this.deleteProgram();
                  // this._events = {};
                  var enableTextures = /^\s*uniform\s+sampler/gm.test(
                    fragmentShader
                  );
                  if (fragmentShader == null)
                    fragmentShader =
                      _default_frag_glsl__WEBPACK_IMPORTED_MODULE_9___default.a;
                  if (vertexShader == null)
                    vertexShader = enableTextures
                      ? _default_feeback_vert_glsl__WEBPACK_IMPORTED_MODULE_10___default.a
                      : _default_vert_glsl__WEBPACK_IMPORTED_MODULE_8___default.a;
                  var gl = this.gl;

                  var program = Object(
                    _helpers__WEBPACK_IMPORTED_MODULE_7__["createProgram"]
                  ...
                  var pattern = new RegExp(
                    "(?:attribute|in) vec(\\d) ".concat(
                      this.options.vertexPosition
                    ),
                    "im"
                  );
                  ...
                  var texCoordPattern = new RegExp(
                    "(?:attribute|in) vec(\\d) ".concat(
                      this.options.vertexTextureCoord
                    ),
                    "im"
                  );
                  ...
                  if (matched) {
                    for (var i = 0; i < matched.length; i++) {
                      ...
                      if (
                        _matched &&
                        _matched[3] !== this.options.vertexPosition &&
                  ...
                  var uniformPattern =
                    /^\s*uniform\s+(\w+)\s+(\w+)(\[\d+\])?/gm;
                  matched = vertexShader.match(uniformPattern) || [];
                  matched = matched.concat(
                    fragmentShader.match(uniformPattern) || []
                  );
              ...
              },
              {
                ...
                value: function compileSync(frag, vert) {
                  ...
                  function _compile(content) {
                    ...
                    var includes = [];
                    var matched = content.match(/^#pragma\s+include\s+.*/gm);
              ...
              },
              {
                ...
                value: function createTexture() {
                  ...
                  var _ref9 =
                    ...
                    minFilter =
                      _ref9$minFilter === void 0
                        ? this.gl.LINEAR
                        : _ref9$minFilter,
                    _ref9$magFilter = _ref9.magFilter,
                    magFilter =
                      _ref9$magFilter === void 0
                        ? this.gl.LINEAR
                        : _ref9$magFilter;

                  var gl = this.gl;
                  var target = Array.isArray(img)
                    ? gl.TEXTURE_CUBE_MAP
                    : gl.TEXTURE_2D;
                  this._max_texture_image_units =
                    this._max_texture_image_units ||
                    gl.getParameter(gl.MAX_COMBINED_TEXTURE_IMAGE_UNITS);
                  gl.activeTexture(
                    gl.TEXTURE0 + this._max_texture_image_units - 1
                  );
                  ...
                  if (img) {
                    ...
                    for (var _i = 0; _i < 6; _i++) {
                      this.gl.texImage2D(
                        this.gl.TEXTURE_CUBE_MAP_POSITIVE_X + _i,
                        0,
                        gl.RGBA,
                        width,
                        height,
              ...
              },
              {
                ...
                value: function createFBO() {
                  var _ref11 =
                    ...
                    stencil =
                      _ref11$stencil === void 0
                        ? !!this.options.stencil
                        : _ref11$stencil;
              ...
              },
              {
                ...
                value: function render() {
                  var _ref12 =
                    ...
                    clearBuffer =
                      _ref12$clearBuffer === void 0 ? true : _ref12$clearBuffer;
        ...
        _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(
          Renderer,
          "USHORT",
          Renderer.UNSIGNED_SHORT
        );

        _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(
          Renderer,
          "fetchShader",
          _helpers__WEBPACK_IMPORTED_MODULE_7__["fetchShader"]
        );

        _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(
          Renderer,
          "loadImage",
          _helpers__WEBPACK_IMPORTED_MODULE_7__["loadImage"]
        );
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        function createProgram(gl, vertex, fragment) {
          ...
          if (!gl.getShaderParameter(vertShdr, gl.COMPILE_STATUS)) {
            var msg =
              "Vertex shader failed to compile.  The error log is:".concat(
          ...
          if (!gl.getShaderParameter(fragShdr, gl.COMPILE_STATUS)) {
            var _msg =
              "Fragment shader failed to compile.  The error log is:".concat(
          ...
          if (!gl.getProgramParameter(program, gl.LINK_STATUS)) {
            var _msg2 =
              "Shader program failed to link.  The error log is:".concat(
        ...
        function pointsToBuffer(points) {
          ...
          var buffer =
            arguments.length > 2 && arguments[2] !== undefined
              ? arguments[2]
              : null;
          if (buffer && !(buffer instanceof Type))
        ...
        function loadImage(src) {
          var _ref =
            ...
            useImageBitmap =
              _ref$useImageBitmap === void 0 ? true : _ref$useImageBitmap,
                ...
                !(
                  (typeof location === "undefined"
                    ...
                    : _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2___default()(
                        location
                      )) === "object" && /^file:/.test(location.href)
