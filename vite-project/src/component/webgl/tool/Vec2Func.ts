 ...
 * @returns {vec2} out
 */
export function copy(out: any[], a: any[]) {
    out[0] = a[0];
    out[1] = a[1];
    return out;
}
 ...
 * @returns {vec2} out
 */
export function set(out: any[], x: any, y: any) {
    out[0] = x;
    out[1] = y;
    return out;
}
 ...
 * @returns {vec2} out
 */
export function add(out: any[], a: any[], b: any[]) {
    out[0] = a[0] + b[0];
    out[1] = a[1] + b[1];
    return out;
}
 ...
 */
export function squaredLength(a: any[]) {
    var x = a[0],
        y = a[1];
    return x * x + y * y;
};
 ...
 * @returns {vec2} out
 */
export function lerp(out: any[], a: any[], b: number[], t: number) {
    var ax = a[0],
        ay = a[1];
    out[0] = ax + t * (b[0] - ax);
    out[1] = ay + t * (b[1] - ay);
 ...
 * @returns {vec2} out
 */
export function transformMat2(out: number[], a: any[], m: number[]) {
    var x = a[0],
        y = a[1];
    out[0] = m[0] * x + m[2] * y;
    out[1] = m[1] * x + m[3] * y;
 ...
 * @returns {vec2} out
 */
export function transformMat2d(out: any[], a: any[], m: number[]) {
    var x = a[0],
        y = a[1];
 ...
 * @returns {vec2} out
 */
export function transformMat3(out: any[], a: any[], m: number[]) {
    var x = a[0],
        y = a[1];
 ...
 * @returns {vec2} out
 */
export function transformMat4(out: any[], a: any[], m: number[]) {
    let x = a[0];
    let y = a[1];
 ...
 */
export function exactEquals(a: any[], b: any[]) {
    return a[0] === b[0] && a[1] === b[1];
}