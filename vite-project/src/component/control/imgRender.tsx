import React , { useContext,useEffect,useState,useCallback } from 'react';
     //四个坐标点定位区域
  const position = (sw:number,sh:number,x:number,y:number,rotate:number)=>{
...
export {position,getImageLines,findCrossPoints,controlPosition,rgba,drawBorder,drawImg,drawRect};