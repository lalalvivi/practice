...
const  TextStyle:React.FC<childProps>=(props)=> {
    const {fontSize,changeFontSize,fontFamily,changeFontFamily,textAlign,changeTextAlign,textBaseline,changeTextBaseline,direction,changeDirection}=props;
    return (
        <div>
          <span>字号：</span>
          <input
          ...
          <select
            value={textBaseline}
            onChange={(e) => changeTextBaseline(e.target.value)}
          >
